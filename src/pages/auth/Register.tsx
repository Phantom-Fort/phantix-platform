          ...
          <div className="card p-7">
            ...
            <form onSubmit={submit} className="space-y-4">
              <div>
                ...
                <input className="input" value={name} onChange={(e) => setName(e.target.value)} placeholder="Acme Financial Group" />
              </div>
              <div>
                <label className="label">Primary sign-in email</label>
                <input className="input" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@acme.ng" />
