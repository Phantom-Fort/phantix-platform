...
export const docs: DocEntry[] = [
  ...
  { id: "howto-platform-04", title: "Assign dual control", description: "Set the initiator and authorizer for sensitive actions.", category: "how-to-platform", content: howto04 },
  ...
  { id: "howto-platform-09", title: "Unlock operate", description: "Start a dual-control operate session.", category: "how-to-platform", content: howto09 },
